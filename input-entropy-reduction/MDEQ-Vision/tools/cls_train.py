...
def parse_args():
    ...
    parser.add_argument('--percent',
                        ...
                        type=float,
                        default=1.0)
    parser.add_argument('--isUnrollTrain',
                        help='if True, use the ckpt trained with the unrolling version phantom gradient',
                        action='store_true')
    parser.add_argument('--isUnrollGrad',
                        help='if True, use the unrolling version phantom gradient to generate adversaries',
                        action='store_true')
